...
export default function GarantiaSection({ onCtaClick }: GarantiaSectionProps) {
  return (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-gray-400 text-base md:text-lg leading-relaxed max-w-2xl mx-auto space-y-5 text-left md:text-center">
          ...
          <p className="font-serif italic text-[#f0d78c] text-xl md:text-2xl mt-10 leading-snug">
            Ou esse material te ajuda a faturar com arte sacra e construir uma nova fonte de renda…
            ou você não paga nada por isso. Simples assim.
          </p>
        </div>
