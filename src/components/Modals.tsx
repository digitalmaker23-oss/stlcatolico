...
export default function Modals({
  ...
  return (
    <>
      {/* Upsell Modal (when clicking Escolher Básico) */}
      {isUpsellOpen && (
        <div
          id="upsell"
          ...
          <div className="bg-[#1a1a1a] max-w-lg w-full rounded-2xl shadow-2xl shadow-black relative border border-[#c9a84c]/40 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-8 md:p-10 text-center">
              <p className="text-gray-300 text-base md:text-lg mb-8 leading-relaxed">
                Antes de sair, aproveite o Plano Básico por apenas R$ 10,90 e tenha acesso imediato
                ao conteúdo.
              </p>
